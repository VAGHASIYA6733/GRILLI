...
const hotels = [
  {
    ...
    description:
      "3 Seventy Bistro in Surat offers a vibrant ambiance, delectable cuisine,and live entertainment, creating a perfect blend for memorable dining experiences.",
  ...
  },
  {
    ...
    description:
      "7Colours in Surat offers a diverse culinary experience and versatile banquet facilities, ensuring delightful meals and memorable events for guests.",
    image:
      "./img/Hotel image/2. 7colours Multi Cuisine Restaurant & Banquet surat.jpg",
  },
  {
    id: 3,
    name: "Aavkar Restaurant",
    description:
      "Aavkar Restaurant in Surat offers a culinary journey with authentic flavors, creating a memorable dining experience in a welcoming ambiance.",
  ...
  },
  {
    ...
    description:
      "Alankar Restaurant in Surat serves delectable dishes, blending traditional flavors with a modern twist, ensuring a delightful culinary experience.",
  ...
  },
  {
    ...
    description:
      "Allure Restaurant in Surat offers a chic dining experience, combinin exquisite cuisine, elegant ambiance, and impeccable service for memorable occasions.",
  ...
  },
  {
    ...
    description:
      "Alpha Restaurant in Surat offers a diverse menu, blending flavors from around the world, creating a delightful culinary experience for all.",
  ...
  },
  {
    ...
    description:
      "Amira's Restaurant in Surat Sarthana Jakatnaka offers delectable cuisine, blending traditional and contemporary flavors, ensuring a delightful dining experience for all.",
    image:
      "./assets/images/Hotel image/7. Amiras Resturant surat sarthana jakatnaka.jpeg",
  },
  {
    id: 8,
    name: "Amor Restaurant",
    description:
      "Amor Restaurant in Surat offers a romantic ambiance and diverse menu, creating a delightful dining experience with exquisite flavors and charm.",
  ...
  },
  {
    ...
    description:
      "Atithi Garden Restaurant in Surat offers a serene dining experience amidst lush greenery, serving delectable cuisine with impeccable hospitality.",
  ...
  },
  {
    ...
    description:
      "Avadh Family Restaurant in Varachha, Surat, offers a warm ambiance and delectable cuisine, making it a perfect destination for family gatherings.",
    image:
      "./assets/images/Hotel image/10. Avadh family restaurant in Varachha, Surat.jpg",
  },
  {
    id: 11,
    name: "Baba Sai Dhosa",
    description:
      "Baba Sai Dosa in Surat serves flavorful and crispy dosas, offering a taste of authentic South Indian cuisine in a casual setting.",
  ...
  },
  {
    ...
    name: "Basil Garden",
    description:
      "Basil Garden in Surat is a charming eatery known for its delightful ambiance and scrumptious dishes, offering a diverse culinary experience.",
  ...
  },
  {
    ...
    description:
      "Bawarchi Restaurant in Surat offers a diverse menu in a welcomin ambiance, promising a delightful dining experience with flavorful cuisines.",
  ...
  },
  {
    ...
    description:
      "Bay Leaf Restaurant and Banquet in Adajan, Surat, offers a sophisticated venue for events along with delectable culinary offerings.",
    image:
      "./assets/images/Hotel image/14. bay-leaf-restaurant-and-banquet-adajan-surat.jpg",
  },
  {
    id: 15,
    name: "Blue Basil Restaurant",
    description:
      "Blue Basil Restaurant in Surat offers a chic ambiance and a diverse menu, delivering a delightful dining experience with culinary excellence.",
  ...
  },
  {
    ...
    name: "Blue Coriander",
    description:
      "Blue Coriander offers a diverse culinary experience with a chic ambiance in Surat, presenting a delightful fusion of flavors and cuisines.",
  ...
  },
  {
    ...
    description:
      "Bnasri Restaurant and Banquet in Surat offers a blend of delightful cuisine and event facilities, promising a memorable experience for patrons.",
    image:
      "./assets/images/Hotel image/17. bnasri Resturant and banqute surat.jpg",
  },
  {
    id: 18,
    name: "Budget inn Bellevue",
    description:
      "Budget in Bellevue Surat offers affordable accommodations with essential amenities, providing a comfortable stay for budget-conscious travelers in a convenient location.",
  ...
  },
  {
    ...
    description:
      "Yummy Tummy Dosa in Surat offers delectable dosas with a variety of fillings, providing a flavorful South Indian culinary experience.",
  ...
  },
  {
    ...
    description:
      "Cook Dooo Cook Restaurant in Surat offers a diverse menu with a unique twist, promising a delightful culinary experience for patrons.",
  ...
  },
  {
    ...
    description:
      "Darshan Restaurant & Banquet in Surat offers a blend of delectable cuisine and event facilities, ensuring memorable experiences for patrons.",
  ...
  },
  {
    ...
    description:
      "Dawat Restaurant in Surat offers a diverse culinary experience with delectable dishes in a welcoming setting, ensuring a delightful dining experience.",
  ...
  },
  {
    ...
    name: "DB villa",
    description:
      "DB Villa offers luxurious accommodations in a serene environment in Surat, combining modern amenities with a touch of elegance for guests' comfort.",
  ...
  },
  {
    ...
    description:
      "De' Villa Garden Restro Lounge in Surat offers a picturesque terrace garden and party plot, providing a charming venue for celebrations.",
    image:
      "./assets/images/Hotel image/24. De' Villa Garden Restro Lounge  Terrace Garden  Party Plot surat.jpg",
  },
  {
    id: 25,
    name: "Deck 9 Restaurant",
    description:
      "Deck 9 Restaurant in Surat offers a scenic ambiance and diverse menu, promising a delightful dining experience with delectable culinary offerings.",
  ...
  },
  {
    ...
    description:
      "Deewan E Khaas in Surat offers a royal dining experience with exquisite Indian cuisine in a regal and opulent setting.",
  ...
  },
  {
    ...
    description:
      "Dhakka Muki Restaurant offers a unique dining experience with its innovative menu and vibrant ambiance in Surat, promising culinary delights.",
  ...
  },
  {
    ...
    description:
      "Dil Se Re Restaurant in Surat offers a heartwarming dining experience with a diverse menu and a welcoming ambiance for patrons.",
  ...
  },
  {
    ...
    description:
      "Dishoom: The Bollywood Restaurant in Surat offers a vibrant dining experience with Bollywood-inspired decor and a menu of eclectic dishes.",
    image:
      "./assets/images/Hotel image/29. dishoom the bollywood resturant.jpg",
  },
  {
    id: 30,
    name: "DMW - Best Dimsum Momos & Wontons",
    description:
      "DMW Best Dimsum Moments in Surat serves delectable and authentic dim sum, offering a delightful culinary experience for dim sum enthusiasts.",
  ...
  },
  {
    ...
    name: "Dosa Charcoal",
    description:
      "Dosa Charcoal in Surat offers a delectable menu of South Indian delights with a unique charcoal twist, creating a memorable culinary experience.",
  ...
  },
  {
    ...
    name: "Dosa Sigdi",
    description:
      "Dosa Sigdi in Surat serves delicious South Indian dosas with a unique twist, offering a delightful culinary experience for all.",
  ...
  },
  {
    ...
    description:
      "Downtown Cafe and Restaurant in Surat offers a chic ambiance and diverse menu, combining flavors to create a memorable dining experience.",
    image:
      "./assets/images/Hotel image/33. Downtwon cafe and resturant surat.jpeg",
  },
  {
    id: 34,
    name: "Dream Festiva Restaurant",
    description:
      "Dream Festival Restaurant in Surat offers a gastronomic journey with a diverse menu, creating a dreamy dining experience for patrons.",
  ...
  },
  {
    ...
    description:
      "East Asia Veg Jain in Surat offers a delightful vegetarian dining experience, showcasing the diverse flavors of East Asian cuisine.",
  ...
  },
  {
    ...
    description:
      "Egg Corner Restaurant is a delightful culinary destination, offering a diverse menu that celebrates the versatility and deliciousness of eggs.",
  ...
  },
  {
    ...
    description:
      "Famous Chinese Cuisine in Surat offers a delectable menu showcasing authentic flavors and culinary expertise for a delightful dining experience.",
  ...
  },
  {
    ...
    description:
      "Farm to Table Cafe & Restro in Surat offers fresh, locally sourced ingredients, creating a wholesome dining experience with sustainability at its core.",
    image:
      "./assets/images/Hotel image/38. Farm to table cafe & restro surat.jpg",
  },
  {
    id: 39,
    name: "Galaxy Revolving Restaurant & Banquet",
    description:
      "Galaxy Revolving Restaurant and Banquet Hall offers a unique dining experience with panoramic views and versatile event spaces in Surat.",
    image:
      "./assets/images/Hotel image/39. Galaxy Revolving Restaurant and Banquet Hall.jpg",
  },
  {
    id: 40,
    name: "Gate To Goa",
    description:
      "Gate to Goa in Surat transports diners with its vibrant ambiance, offering a taste of Goa's exotic flavors in every dish.",
  ...
  },
  {
    ...
    description:
      "Geeetha Restaurant in Surat offers delectable Indian cuisine with a diverse menu, impeccable service, and a welcoming ambiance for patrons.",
  ...
  },
  {
    ...
    description:
      "GK's Restaurant in Surat offers a delightful fusion of flavors, impeccable service, and a cozy ambiance for a memorable dining experience.",
  ...
  },
  {
    ...
    description:
      "Glorious Restaurant in Adajan, Surat offers delicious Punjabi cuisine in a family-friendly atmosphere, suitable for functions and parties.",
  ...
  },
  {
    ...
    description:
      "Go China Restaurant in Surat offers exquisite Chinese cuisine with a blend of authentic flavors, welcoming ambiance, and excellent service.",
  ...
  },
  {
    ...
    description:
      "Govardhan Family Restaurant: A warm haven in Surat, serving delicious, homely meals with a touch of love and hospitality.",
  ...
  },
  {
    ...
    description:
      "Haldiram's Restaurant in Surat: Indulge in a delightful culinary experience with an array of authentic Indian dishes and inviting ambiance.",
  ...
  },
  {
    ...
    description:
      "Haneez Restaurant in Surat: A culinary oasis offering diverse and delectable dishes in a cozy ambiance, perfect for memorable dining experiences.",
  ...
  },
  {
    ...
    description:
      "Harikrishna Restaurant in Surat: A culinary destination offering a blend of traditional and innovative dishes in a vibrant atmosphere.",
  ...
  },
  {
    ...
    description:
      "Harikrishna Village Hotel in Surat: A tranquil retreat offering comfortable accommodation and warm hospitality, blending modern amenities with serene surroundings.",
    image:
      "./assets/images/Hotel image/49. Harikrishna village hotel surat.jpg",
  },
  {
    id: 50,
    name: "Hotel Satlaj",
    description:
      "Hotel Saltaj in Surat: A chic haven offering comfortable lodging with modern amenities, ensuring a pleasant stay in the vibrant city.",
  ...
  },
  {
    ...
    name: "Hummus House",
    description:
      "Hummus House: A delightful eatery offering a variety of flavorful hummus dishes in a cozy setting, perfect for casual dining.",
  ...
  },
  {
    ...
    description:
      "Jalaram Khichadi Restaurant in Surat: A culinary haven offering a delightful variety of khichadi dishes, combining flavors and comfort in every bite.",
    image:
      "./assets/images/Hotel image/52. jalaram khichadi resturant surat.jpg",
  },
  {
    id: 53,
    name: "Kabir Restaurant",
    description:
      "Kabir Restaurant: A culinary oasis in Surat, offering a diverse menu of flavorful dishes in a welcoming ambiance for memorable dining.",
  ...
  },
  {
    ...
    description:
      "Kaka Ni Bhaji in Surat: A savory delight, offering a variety of delectable bhaji dishes, capturing the essence of local flavors.",
  ...
  },
  {
    ...
    description:
      "Kansar Gujarati Thali in Nanpura, Surat: Indulge in a delightful array of authentic Gujarati dishes, showcasing the rich culinary heritage.",
    image:
      "./assets/images/Hotel image/55. kansar-gujarati-thali-nanpura-surat.jpg",
  },
  {
    id: 56,
    name: "King's Corner",
    description:
      "Kings Corner in Surat Vesu: A regal dining experience, offering a royal menu with exquisite dishes in a luxurious ambiance.",
  ...
  },
  {
    ...
    name: "KK Thali",
    description:
      "KK Thali in Surat: A delightful culinary experience, offering a variety of flavorsome dishes in a welcoming and vibrant atmosphere.",
  ...
  },
  {
    ...
    description:
      "Krishna Restaurant in Buhari, Surat: A top-notch dining destination, offering the best culinary delights with impeccable service in Surat.",
    image:
      "./assets/images/Hotel image/58. Krishna Restaurant in Buhari,Surat - Best Restaurants in Surat.jpg",
  },
  {
    id: 59,
    name: "Kurtosshhh...",
    description:
      "Kurtosshhh: Savor the delightful swirls of chimney cakes, a sweet and crispy treat, at this charming bakery. A unique indulgence awaits!",
  ...
  },
  {
    ...
    name: "La Festa",
    description:
      "La Festa: A charming spot offering a taste of Italy with delectable pizzas, pastas, and a warm ambiance in Surat.",
  ...
  },
  {
    ...
    description:
      "La Fountain The Food Fair in Surat offers a diverse culinary experience, featuring a variety of delicious dishes in a vibrant and inviting atmosphere.",
    image:
      "./assets/images/Hotel image/61. La Fountain The Food Fair, Surat.jpg",
  },
  {
    id: 62,
    name: "Lake view Restaurant",
    description:
      "Lake View Restaurant in Surat offers a picturesque dining experience with stunning views, complemented by a diverse menu of delectable dishes.",
  ...
  },
  {
    ...
    name: "La Pepper Dosa",
    description:
      "Le Pepper Dhiosa in Surat presents a tantalizing blend of flavors, offering a unique culinary experience with its diverse and exquisite dishes.",
  ...
  },
  {
    ...
    description:
      "Lemon Grass Garden Restaurant in Surat offers a refreshing dining experience with its vibrant ambiance and a menu featuring delightful citrus-infused dishes.",
    image:
      "./assets/images/Hotel image/64. lemon gravss gardeb resturant surat.jpg",
  },
  {
    id: 65,
    name: "Leonardo Italian Mediterranean Dining",
    description:
      "Leonardo Italian Mediterranean Dining in Surat, Gujarat, offers an exquisite blend of Italian and Mediterranean flavors in a sophisticated ambiance.",
    image:
      "./assets/images/Hotel image/65. leonardo italian mediterranean dining surat gujarat.jpg",
  },
  {
    id: 66,
    name: "Let's Table Talk",
    description:
      "Let's Table Talk Restaurant in Surat provides a cozy setting for engaging conversations over delicious meals, creating memorable dining experiences.",
    image:
      "./assets/images/Hotel image/66. let's table talk Resturant surat.jpg",
  },
  {
    id: 67,
    name: "London Yard Pizza",
    description:
      "London Yard Pizza in Surat offers a delectable slice of London with its flavorful pizzas in a vibrant and inviting ambiance.",
  ...
  },
  {
    ...
    description:
      "Lukmaa Multi Cuisine Restaurant in Surat provides a diverse culinary experience, serving a variety of flavorful dishes in a welcoming setting.",
    image:
      "./assets/images/Hotel image/68. Lukmaa Multi Cuisine Restaurant surat.jpg",
  },
  {
    id: 69,
    name: "Mad Over Grills",
    description:
      "Mad Over Grills in Surat is a sizzling haven for grill enthusiasts, offering a delectable array of flavors in a lively ambiance.",
  ...
  },
  {
    ...
    description:
      "Maharaja Palace Restaurant & Banquet in Surat offers pure vegetarian delights in a regal setting, delivering a royal culinary experience.",
    image:
      "./assets/images/Hotel image/70. Maharaja Palace Restaurant & Banquet  Pure Veg Restaurant.jpg",
  },
  {
    id: 71,
    name: "Malhar Dhosa",
    description:
      "Malhar Dosa at Lajamnio Chowk, Surat, offers delectable South Indian cuisine with a diverse menu and a pleasant dining atmosphere.",
    image:
      "./assets/images/Hotel image/71. Malhar dhosa Lajamnio chowk surat.jpg",
  },
  {
    id: 72,
    name: "Masala Hut",
    description:
      "It seems there might be a typo in your request, as you've mentioned 0 wods instead of 0 words. If you'd like a description for Masala Hut in Surat or any other specific location, please clarify, and I'll be happy to assist!",
  ...
  },
  {
    ...
    description:
      "Masala Mania in Surat is renowned for being the best continental, vegetarian restaurant, and cafe, offering diverse flavors and exceptional dining.",
    image:
      "./assets/images/Hotel image/73. Masala Mania - Best Restaurants, Continental Restaurant, Veg Restaurant, Cafe surat.jpg",
  },
  {
    id: 74,
    name: "Masala Stories - A Multi-Cuisine Restaurant",
    description:
      "Masala Stories in Surat: A culinary haven, offering a delightful array of flavors with a cozy ambiance for an unforgettable dining experience.",
  ...
  },
  {
    ...
    name: "Masala Canteen",
    description:
      "Masala Canteen in Surat: A flavorful haven, serving diverse and    mouthwatering dishes, creating a delightful dining experience for every palate.",
  ...
  },
  {
    ...
    name: "Mad 4 Dosa",
    description:
      "Mad 4 Dosa: A dosa paradise in Surat, offering Mad 4 Dosa in Surat is a haven for dosa lovers, curating an extensive menu that transcends the ordinary. ",
  ...
  },
  {
    ...
    description:
      "Midtown Restaurant: A culinary destination in Surat, offering a diverse menu of delectable dishes in a welcoming and vibrant setting.",
  ...
  },
  {
    ...
    name: "Mykonos",
    description:
      "Mykonos Cafe and Restaurant in Surat: A Greek-inspired culinary retreat, offering delectable Mediterranean flavors in a charming and inviting atmosphere.",
    image:
      "./assets/images/Hotel image/78. mykonos cafe and resturant surat.jpg",
  },
  {
    id: 79,
    name: "Navjivan Restaurant",
    description:
      "Navjivan Restaurant in Surat Jakatnaka: A culinary gem offering diverse flavors, delightful dishes, and a warm ambiance for memorable dining experiences.",
    image:
      "./assets/images/Hotel image/79. Navjivan Resturant surat jaktnaka.jpg",
  },
  {
    id: 80,
    name: "Nature's Plate",
    description:
      "Nutur's Plate Surat: A culinary haven, offering a diverse and delectable  menu in a welcoming setting, promising delightful dining experiences.",
  ...
  },
  {
    ...
    name: "Only Dhosa",
    description:
      "I'm sorry, but your request seems unclear. It looks like there might be a typo or missing information. Could you please provide more context or clarify your question?",
  ...
  },
  {
    ...
    name: "Oscar Pizza",
    description:
      "Oscar Pizza Restaurant in Surat offers delicious pizzas, pasta, and more, providing a delightful dining experience with a diverse menu and inviting ambiance.",
  ...
  },
  {
    ...
    name: "Paa Roti Cafe",
    description:
      "Paa Roti is a traditional Indian dish featuring flatbread served with spicy chickpeas, offering a flavorful and satisfying culinary experience.",
  ...
  },
  {
    ...
    description:
      "Papa Louie's Pizza in Surat offers mouthwatering pizzas with quality ingredients, promising a delightful dining experience for pizza enthusiasts in Surat.",
  ...
  },
  {
    ...
    description:
      "Pavilion Restaurant in Surat offers a diverse menu, exquisite flavors, and a pleasant ambiance, ensuring a delightful dining experience for patrons.",
  ...
  },
  {
    ...
    description:
      "Punjabi Di Hatti Restaurant in Surat offers authentic Punjabi cuisine,  featuring flavorful dishes and a welcoming ambiance for delightful dining experiences.",
    image:
      "./assets/images/Hotel image/86. punjabi di hatti restaurant  surat.jpg",
  },
  {
    id: 87,
    name: "Purohit Thali",
    description:
      "Purohit Thali Restaurant offers a delightful culinary experience with authentic flavors, diverse dishes, and warm hospitality in a vibrant ambiance.",
  ...
  },
  {
    ...
    description:
      "Radha Krishna Restaurant in Surat captivates with divine flavors, offering an exquisite culinary journey through delectable dishes and warm hospitality.",
  ...
  },
  {
    ...
    description:
      "Rangoli Garden Restaurant on Canal Road, Surat, offers a delightful culinary escape with vibrant flavors and serene ambiance for all.",
    image:
      "./assets/images/Hotel image/89. Rangoli garden resturant cenal road surat.jpg",
  },
  {
    id: 90,
    name: "Rasna Buzz",
    description:
      "Rasna Buzz in Surat offers a vibrant atmosphere, delicious bites, and refreshing drinks, creating a lively experience for all.",
  ...
  },
  {
    ...
    description:
      "Real Restaurant offers an authentic dining experience with flavorful dishes, attentive service, and a welcoming ambiance for all guests.",
  ...
  },
  {
    ...
    description:
      "Revolving Restaurant in Surat offers a unique dining experience with panoramic views, gourmet cuisine, and a captivating ambiance for patrons.",
  ...
  },
  {
    ...
    description:
      "Richie Rich in Surat is a chic destination offering premium experiences with luxurious ambiance, delectable cuisine, and attentive service.",
  ...
  },
  {
    ...
    name: "RIO Carnival",
    description:
      "Rio Carnival Restaurant: A vibrant culinary carnival awaits, featuring  bold flavors, lively atmosphere, and a celebration of Brazilian cuisine in every dish.",
  ...
  },
  {
    ...
    description:
      "Royal Dine Pal RTO: An exquisite dining experience awaits, featuring regal ambiance, impeccable service, and a diverse, flavorful menu for patrons.",
  ...
  },
  {
    ...
    description:
      "Royal Dine Surat: A regal dining experience with exquisite cuisine, elegant ambiance, and versatile banquet facilities for special celebrations.",
  ...
  },
  {
    ...
    description:
      "Sarvottam The Restaurant in Udhna Village, Surat: Culinary excellence, warm hospitality, and a diverse menu await discerning patrons.",
    image:
      "./assets/images/Hotel image/97. Sarvottam The Restaurant udhna village surat.jpg",
  },
  {
    id: 98,
    name: "Sasumaa Gujarati Thali",
    description:
      "Sasumaa Gujarati Thali in Surat: Authentic Gujarati flavors, diverse  thali offerings, and warm hospitality create a delightful dining experience.",
  ...
  },
  {
    ...
    description:
      "Satkar Restaurant in Surat: Culinary excellence, inviting ambiance, and a diverse menu, creating a delightful experience for discerning patrons.",
  ...
  },
  {
    ...
    description:
      "Shiva Garden Restaurant in Surat: A tranquil dining spot with delightful  cuisine, lush surroundings, and warm hospitality for all patrons.",
  ...
  },
  {
    ...
    description:
      " Shree Sainath Snacks And Juices offers a delightful menu of snacks and  refreshing juices, satisfying your cravings with flavorful options.",
    image:
      "./assets/images/Hotel image/101. Shree Sainath Snacks And Juices.jpg",
  },
  {
    id: 102,
    name: "Sigdi Restaurant",
    description:
      "Sigdi Restaurant in Surat is a culinary gem, offering a spectrum of delightful dishes that capture the essence of authentic flavors.",
  ...
  },
  {
    ...
    description:
      "Silver Nest Restaurant in Surat is a popular dining destination known  for its delicious and flavorful Indian cuisine.",
  ...
  },
  {
    ...
    description:
      "it operates under the brand name “The Grand Bhagwati” also known as TGB across India.",
    image:
      "./assets/images/Hotel image/104. Simply South By Taste Of Bhagwati surat.jpg",
  },
  {
    id: 105,
    name: "Smokey Chilly",
    description:
      "Smokey Chilly in Surat brings a fiery twist to flavors, offering a tantalizing fusion of smokiness and spice in every dish.",
  ...
  },
  {
    ...
    description:
      "Spice Delight in Surat offers a palate-pleasing experience, crafting  delectable dishes with a harmonious blend of aromatic spices and flavors.",
    image:
      "./assets/images/Hotel image/106. Spice Delight Restaurant surat.jpg",
  },
  {
    id: 107,
    name: "Spice Heritage",
    description:
      "Spice Heritage Restaurant in Surat offers a cultural culinary  experience, showcasing a rich heritage of flavors through its diverse menu.",
    image:
      "./assets/images/Hotel image/107. spice heritage resturant surat.jpg",
  },
  {
    id: 108,
    name: "Spice Terrace Restaurant",
    description:
      "Spice Terrace Restaurant in Surat offers a delightful dining experience, combining aromatic spices with a serene outdoor ambiance for patrons.",
  ...
  },
  {
    ...
    description:
      "Spice Villa Restaurant in Surat offers a flavorful escape with its  diverse menu, showcasing a culinary journey through aromatic spices.",
  ...
  },
  {
    ...
    description:
      "Spruce Petals, a fine-dining restaurant, in Surat offers an exquisite culinary experience with a blend of elegance, flavors, and sophistication.",
    image:
      "./assets/images/Hotel image/110. spuce petals - fine dine restro.jpg",
  },
  {
    id: 111,
    name: "Status Café & Restaurant",
    description:
      "Status Café & Restaurant in Surat offers a delightful fusion of flavors, impeccable service, and a chic ambiance for a memorable dining experience.",
    image:
      "./assets/images/Hotel image/111. Status Café & Restaurant surat.jpg",
  },
  {
    id: 112,
    name: "Steam Restaurant",
    description:
      "Steam Restaurant in Surat: A culinary haven where delectable flavors and  stylish ambiance come together, promising an unforgettable dining experience.",
  ...
  },
  {
    ...
    description:
      "Suart Restaurant in Surat: A culinary destination offering diverse  flavors and warm hospitality, creating a memorable dining experience for all patrons.",
  ...
  },
  {
    ...
    name: "Sugar N Spice",
    description:
      "Sugar n' Spice in Surat: A sweet escape offering delectable treats and  delightful bites in a cozy setting for indulgent moments.",
  ...
  },
  {
    ...
    description:
      "Taaza Restaurant in Surat: Fresh flavors, impeccable service, and a  welcoming ambiance create a delightful dining experience for all patrons.",
  ...
  },
  {
    ...
    name: "Table 101",
    description:
      "Table 101 Restaurant in Surat: Exquisite cuisine, elegant setting, and personalized service create a memorable dining experience for all guests.",
  ...
  },
  {
    ...
    description:
      "Taste of Bhagwati in Surat: A culinary haven offering a delightful blend of traditional and contemporary flavors in a cozy setting.",
  ...
  },
  {
    ...
    name: "Taste of India",
    description:
      "Taste of India in Surat: A culinary voyage through authentic flavors and spices, creating a memorable dining experience for patrons.",
  ...
  },
  {
    ...
    description:
      "The Ropeway Restaurant in Surat: Elevated dining with panoramic views, offering delectable cuisine and a unique experience in a charming setting.",
  ...
  },
  {
    ...
    description:
      "Thalaivyaa South Indian Restaurant in Surat: Authentic flavors, diverse   dishes, and a cultural ambiance for a true South Indian culinary experience.",
    image:
      "./assets/images/Hotel image/120. thalaivyaa south indian resturant surat.jpg",
  },
  {
    id: 121,
    name: "The Commoner’s Kitchen",
    description:
      "The Commoner's Kitchen: A culinary haven where simplicity meets  excellence, offering a diverse menu and warm hospitality in a cozy setting.",
  ...
  },
  {
    ...
    description:
      "The Green Restaurant in Surat: A culinary oasis embracing freshness, offering a vibrant menu and eco-friendly practices in a serene setting.",
  ...
  },
  {
    ...
    description:
      "The Lime Tree Restaurant in Surat: A citrus-inspired culinary  experience, blending refreshing flavors and a cozy atmosphere for memorable dining.",
    image:
      "./assets/images/Hotel image/123. the lime tree restaurant in surat.jpg",
  },
  {
    id: 124,
    name: "The Secret Kitchen",
    description:
      "The Secret Kitchen in Surat: A culinary sanctuary where mystery and  exquisite flavors converge, creating a unique and memorable dining experience.",
  ...
  },
  {
    ...
    description:
      "The Surya Dosa in Surat: A haven for dosa lovers, offering a diverse  menu of crispy delights and savory fillings in a lively setting.",
  ...
  },
  {
    ...
    description:
      "The Tasty Garden in Surat: A culinary oasis with a delightful menu,  offering diverse flavors in a serene and inviting atmosphere.",
  ...
  },
  {
    ...
    description:
      "The Village Rangoli Restaurant in Surat: A cultural culinary experience  with traditional flavors and vibrant ambiance for an authentic dining journey.",
    image:
      "./assets/images/Hotel image/127. the village rangoli Resturant surat.jpg",
  },
  {
    id: 128,
    name: "The Wan Nestz Resto & Cafe",
    description:
      "The Wan Nestz Restaurant in Surat: A culinary haven with a diverse menu,  promising delightful flavors in a warm and welcoming ambiance.",
  ...
  },
  {
    ...
    description:
      "Tit Bit Culture: Surat's multi-cuisine gem, offering delectable bites  and a banquet hall for memorable celebrations in a vibrant setting.",
    image:
      "./assets/images/Hotel image/129. Tit Bit Culture Multi Cuisine Restaurant & Banquet Hall surat.jpg",
  },
  {
    id: 130,
    name: "Trishiv Chinese",
    description:
      "Trishiv Chinese in Surat: A delightful culinary journey with authentic  Chinese flavors in a cozy setting, promising a memorable dining experience.",
  ...
  },
  {
    ...
    description:
      "Tulsi Restaurant Banquet & Rooms in Lal Darwaja, Surat offers exquisite dining, event hosting, and comfortable accommodations in a vibrant atmosphere.",
    image:
      "./assets/images/Hotel image/131. Tulsi Restaurant Banquet & Rooms in Lal Darwaja,Surat.jpg",
  },
  {
    id: 132,
    name: "UNNATI RESTAURANT",
    description:
      "Unnati Restaurant in Surat offers a culinary delight with a diverse   menu, ensuring a memorable dining experience in a vibrant ambiance.",
  ...
  },
  {
    ...
    name: "Urban Punjab",
    description:
      "Urban Punjab in Surat offers an authentic taste of Punjabi cuisine,   blending traditional flavors with a contemporary dining experience.",
  ...
  },
  {
    ...
    name: "Vintage Asia",
    description:
      "Vintage Asia in Surat offers an exquisite culinary journey with a menu  inspired by the rich and diverse flavors of Asian cuisine.",
  ...
  },
  {
    ...
    description:
      "Vrudavan Restaurant in Surat offers a serene dining experience with  delectable vegetarian cuisine, creating a perfect blend of taste and tranquility.",
  ...
  },
  {
    ...
    description:
      "Way Wait Restaurant in Surat offers a unique dining experience with a  diverse menu, blending flavors and culinary creativity in a welcoming atmosphere.",
  ...
  },
  {
    ...
    description:
      "William John's Pizza Pal in Surat serves delicious pizzas with a variety of toppings, providing a tasty and satisfying dining experience. ",
    image:
      "./assets/images/Hotel image/137. William John's Pizza Pal Surat surat.jpg",
  },
  {
    id: 138,
    name: "Wok On Fire",
    description:
      "Wok On Fire Restaurant in Surat serves flavorful wok dishes, offering a unique culinary experience with a blend of Asian spices.",
  ...
  },
  {
    ...
    description:
      "Zaitoon Restaurant in Surat, India offers delicious and authentic Middle Eastern cuisine, known for its rich flavors and aromatic spices.",
  ...
  },
  {
    ...
    description:
      "Zeero is a new restaurant in Surat that specializes in Cantonese cuisine with contemporary twists. Located in Gaysorn Village, it is headed by renowned Chinese cooking maestro Chan Kwok Hung.",
  ...
  },
  {
    ...
    description:
      "The Zest restaurant in Surat, India offers a variety of Indian dishes, particularly Punjabi food, at reasonable prices. It is known for its tasty Paneer Laziz, Dal, and soups.",
  ...
  },
  {
    ...
    description:
      "Zhingalala Restaurant in Surat, Gujarat, is a Pesco-Vegetarian establishment that offers a wide variety of prawn, fish, and vegetarian dishes.",
  ...
  },
  {
    ...
    description:
      "Ziyafat Restaurant Pure Veg & Crystal Banquet Hall is a highly recommended vegetarian restaurant that offers delicious and high-quality food.",
    image:
      "./assets/images/Hotel image/143. Ziyafat Restaurant Pure Veg & Crystal Banquet Hall.png",
  },
  {
    id: 144,
    name: "Hotel Aatithya",
    description:
      "Hotel Aatithya is a hotel located in Bhubaneshwar, India, near Bhubaneswar Station and Biju Patnaik International Airport.",
...
function searchCafes() {
  ...
  const filteredCafes = cafes
    .filter((cafe) => cafe.name.toLowerCase().includes(searchInput))
    .slice(0, 5);
  console.log(filteredCafes);
  const dispalydata = document
    .getElementById("cafeCardsContainer")
    .classList.add("d-none");
  const dispalydatapagination = document
    .getElementById("pagination-buttons")
    .classList.add("d-none");
  const dispalydatas = document.getElementById("cafeList");
  const dispaly12 = document.getElementById("search123").classList.add("game");
  // .classList.add("back__");

  // Display suggestions
  displaySuggestions(filteredCafes);

  // Display cafe cards
  displayCafeCards(filteredCafes);
}

function displayCafeCards(filteredCafes) {
...
function displaySuggestions(suggestions) {
  ...
  suggestions.forEach((suggestion) => {
    ...
    suggestionItem.addEventListener("click", () => {
      ...
      searchCafes(); // Trigger search with selected suggestion
    });
...
function searchHotels() {
  ...
  const filteredHotels = hotels
    .filter((hotel) => hotel.name.toLowerCase().includes(searchInput))
    .slice(0, 5);
  console.log(filteredHotels);
  const dispalydata = document
    .getElementById("hotelCardsContainer")
    .classList.add("d-none");
  const dispalydatapagination = document
    .getElementById("pagination-buttons")
    .classList.add("d-none");
  const dispalydatas = document.getElementById("hotelList");
  const dispaly12 = document.getElementById("search1234").classList.add("game");

  // Display suggestions
  displaySuggestions(filteredHotels);

  // Display cafe cards
  displayHotelCards(filteredHotels);
}

function displayHotelCards(filteredHotels) {
  ...
  filteredHotels.forEach((hotel) => {
    ...
    <div class="card-footer">
      <button class="learn-more" onclick="viewMore(${hotel.id})">
        <span class="circle" aria-hidden="true">
          <span class="icon arrow"></span>
        </span>
        <span class="button-text">View More</span>
...
function selectHotel(name) {
  ...
  const data = hotels.find((data) => data.name == name);
  const description = data.description;
  const images = data.image;
  console.log(images);
